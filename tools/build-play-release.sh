...
grep -Fq 'android:versionCode="61"' "$BUNDLE_MANIFEST" || fail "expected versionCode 61"
grep -Fq 'android:versionName="1.36.6"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.36.6"
