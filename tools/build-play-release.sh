...
PACK_MANIFEST=static/pack-manifest-v1.29.json
PREVIOUS_PACK_MANIFEST=static/pack-manifest-v1.28.json
OLDER_PACK_MANIFEST=static/pack-manifest-v1.27.json
EARLIER_PACK_MANIFEST=static/pack-manifest-v1.26.json
...
same_file "$PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.29.json" "v1.29 pack manifest mirror"
same_file "$PREVIOUS_PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.28.json" "v1.28 pack manifest mirror"
same_file "$OLDER_PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.27.json" "v1.27 pack manifest mirror"
same_file "$EARLIER_PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.26.json" "v1.26 pack manifest mirror"
...
grep -Fq 'android:versionCode="47"' "$BUNDLE_MANIFEST" || fail "expected versionCode 47"
grep -Fq 'android:versionName="1.29.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.29.0"
