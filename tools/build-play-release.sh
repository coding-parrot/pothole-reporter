...
PACK_MANIFEST=static/pack-manifest-v1.28.json
PREVIOUS_PACK_MANIFEST=static/pack-manifest-v1.27.json
OLDER_PACK_MANIFEST=static/pack-manifest-v1.26.json
...
same_file "$PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.28.json" "v1.28 pack manifest mirror"
same_file "$PREVIOUS_PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.27.json" "v1.27 pack manifest mirror"
same_file "$OLDER_PACK_MANIFEST" "$WWW_ROOT/pack-manifest-v1.26.json" "v1.26 pack manifest mirror"
...
grep -Fq 'android:versionCode="46"' "$BUNDLE_MANIFEST" || fail "expected versionCode 46"
grep -Fq 'android:versionName="1.28.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.28.0"
