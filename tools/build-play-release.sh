...
grep -Fq 'android:versionCode="70"' "$BUNDLE_MANIFEST" || fail "expected versionCode 70"
grep -Fq 'android:versionName="1.39.1"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.39.1"
