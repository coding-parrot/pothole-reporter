...
- Garbage and manhole handoffs are enabled throughout Maharashtra, West Bengal, Punjab, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Uttar Pradesh, and Chhattisgarh,
...
- Selected road-damage images and the user's API key go directly to OpenAI. Garbage and
  ...
  West Bengal, Punjab, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Uttar Pradesh, and Chhattisgarh containment is checked locally against downloaded ODbL state boundaries.
  The 15 structured-city routes require Nominatim's city/municipality and state fields;
