...
grep -Fq 'android:versionCode="41"' "$BUNDLE_MANIFEST" || fail "expected versionCode 41"
grep -Fq 'android:versionName="1.23.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.23.0"
