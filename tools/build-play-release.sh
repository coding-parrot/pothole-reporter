...
grep -Fq 'android:versionCode="40"' "$BUNDLE_MANIFEST" || fail "expected versionCode 40"
grep -Fq 'android:versionName="1.22.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.22.0"
