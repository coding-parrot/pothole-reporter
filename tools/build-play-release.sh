...
grep -Fq 'android:versionCode="53"' "$BUNDLE_MANIFEST" || fail "expected versionCode 53"
grep -Fq 'android:versionName="1.34.1"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.34.1"
