...
for f in standalone.js index.html pack-manifest.json pack-manifest-v1.26.json pack-manifest-v1.27.json highway-manifest.json; do cp "static/$f" "android-app/www/$f"; done
