...
grep -Fq 'android:versionCode="42"' "$BUNDLE_MANIFEST" || fail "expected versionCode 42"
grep -Fq 'android:versionName="1.24.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.24.0"
