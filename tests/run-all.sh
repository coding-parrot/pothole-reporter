...
LOCAL_TESTS="unit_test civic_issue_test state_pack_validation_test state_pack_test national_highway_pack_test national_highway_routing_test pages_assets_test municipal_city_routing_test home_actions_test mumbai_routing_test maharashtra_routing_test kolkata_routing_test delhi_routing_test submission_truth_test mumbai_ui_test kolkata_ui_test delhi_ui_test eval_contract_test persistent_dedupe_test footage_metadata_test drive_start_stop_test orphan_footage_test capture_cadence_test letter_test storage_commit_test stalled_body_test
