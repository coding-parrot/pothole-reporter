...
grep -Fq 'android:versionCode="62"' "$BUNDLE_MANIFEST" || fail "expected versionCode 62"
grep -Fq 'android:versionName="1.36.7"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.36.7"
