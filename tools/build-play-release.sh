...
grep -Fq 'android:versionCode="50"' "$BUNDLE_MANIFEST" || fail "expected versionCode 50"
grep -Fq 'android:versionName="1.32.0"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.32.0"
